...
object Main {
  ...
  def solve(sc: => Scanner): Unit = {
    val N = Array.fill(sc.nextInt)((sc.nextLong, sc.nextLong))
    println(Array.fill(sc.nextInt)((sc.nextLong, sc.nextLong)).zipWithIndex.foldLeft((Seq[Long](0), -1))((a, b) => {
      val count = N.foldLeft(0)((c, d) => c + (if (d._1 >= b._1._1 && d._2 <= b._1._2) (1) else (0)))
      if (count == 0) (a) else if (count == a._2) ((a._1 :+ b._2.toLong + 1), count) else if (count > a._2) ((Seq[Long](b._2 + 1), count)) else (a)
    }
    )._1.mkString("\n"))
  }

...
object Main {
  ...
  def solve(sc: => Scanner): Unit = {
    val A = Array.fill(sc.nextInt())((sc.nextLong(), sc.nextLong(), sc.nextLong())).reduce { (a, b) => (math.max(a._2, a._3) + b._1, math.max(a._3, a._1) + b._2, math.max(a._1, a._2) + b._3)
    }
    println(math.max(A._1, math.max(A._2, A._3)))
  }

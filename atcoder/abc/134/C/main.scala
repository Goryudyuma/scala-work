...
object Main {
  def solve(sc: => Scanner): Unit = {
    val N = sc.nextInt()
    val X = Array.fill(N)(sc.nextLong()).zipWithIndex.foldLeft(((-1, -1L), -1L))((A, B) => {
      if (A._1._2 < B._1) ((B._2, B._1), A._1._2)
      else if (A._2 < B._1) (A._1, B._1)
      else A
    })
    (0 until N).foreach(i => println(if (X._1._1 == i) X._2 else X._1._2))
  }
